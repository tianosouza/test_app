...
# Use gem devise for authentication [https://github.com/heartcombo/devise]
gem "devise"

group :development, :test do
  # See https://guides.rubyonrails.org/debugging_rails_applications.html#debugging-with-the-debug-gem
  gem "debug", platforms: %i[ mri windows ]
  # Rspec-rails is a testing framework for Rails [https://github.com/rspec/rspec-rails]
  ...
  # Use raisl controller testig [https://github.com/rails/rails-controller-testing]
